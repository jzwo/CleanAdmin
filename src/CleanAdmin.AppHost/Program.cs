...
var migrationService = builder.AddProject<Projects.CleanAdmin_MigrationService>("migration")
    .WithReference(postgresDb)
    .WaitFor(postgresDb);

// Add web project with infrastructure dependencies
var apiService = builder.AddProject<Projects.CleanAdmin_ApiService>("apiservice")
...
builder.AddProject<Projects.CleanAdmin_Web>("webfrontend")
    .WithExternalHttpEndpoints()
    .WithHttpHealthCheck("/health")
